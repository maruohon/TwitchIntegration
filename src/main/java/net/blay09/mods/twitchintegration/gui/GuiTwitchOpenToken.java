...
public class GuiTwitchOpenToken extends GuiConfirmOpenLink {
    ...
    private static String getInfoText() {
        return I18n.format(Reference.MOD_ID + ":gui.openToken.requiredPermissions") + "\n" +
                TextFormatting.GRAY + I18n.format(Reference.MOD_ID + ":gui.openToken.logIntoChat") + "\n\n" +
                TextFormatting.RESET + I18n.format(Reference.MOD_ID + ":gui.openToken.openedInBrowser");
    }
    ...
    public void copyLinkToClipboard() {
        ...
        buttonList.stream().filter(p -> p.id == 2).findAny().ifPresent(p -> p.displayString = I18n.format(Reference.MOD_ID + ":gui.openToken.copied"));
    }
